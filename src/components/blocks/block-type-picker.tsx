...
const blockTypeOptions: BlockTypeOption[] = [
  ...
  },
  {
    type: "heading_1",
    label: "Heading 1",
    icon: <Heading1 className="h-[18px] w-[18px]" />,
  ...
  },
  {
    type: "heading_2",
    label: "Heading 2",
    icon: <Heading2 className="h-[18px] w-[18px]" />,
  ...
  },
  {
    type: "heading_3",
    label: "Heading 3",
    icon: <Heading3 className="h-[18px] w-[18px]" />,
  ...
  },
  {
    type: "callout",
    label: "Callout",
    icon: <MessageSquareQuote className="h-[18px] w-[18px]" />,
